...
export const MOCKCATEGORIES = [
    ...
    new Category("A2", 2, false, Period.period_2(), 32, 3, 31, 33, undefined, [321, 322]),
    new Category("A3", 3, false, Period.period_4(), 33, 3, 32, undefined, undefined, [331]),
    new Category("B1", 1, false, Period.period_2(), 321, 3, undefined, undefined, 32),
    new Category("C1", 1, false, Period.period_3(), 322, 3, undefined, undefined, 32),
    new Category("D1", 1, false, Period.period_4(), 331, 3, undefined, undefined, 33),
];
