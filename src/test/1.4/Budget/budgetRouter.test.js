...
describe("GET /budget/:id", () => {
    describe("testbudget_a", () => {
        ...
        it("Should return budget with 0 root elements", () => __awaiter(void 0, void 0, void 0, function* () {
            // get
            let response = yield chai
                .request(BASEURL)
                .get("/budget/" + TESTBUDGET_A_ID);
...
describe("GET /budget/:id/:year/:month", () => {
    ...
    describe("testbudget_a", () => {
        ...
        describe("period 0", () => {
            ...
            it(`Should return status ${STATUSCODE} of type "${typeof STATUSCODE}"`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
            ...
            it(`Should return content-type: ${CONTENTTYPE} of type "${typeof CONTENTTYPE}"`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget named ${BUDGETNAME} of type "${typeof BUDGETNAME}"`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai.request(BASEURL).get(QUERYSTRING);
                // manipulate
                let budget = response.body;
            ...
            it(`should return budget with id ${BUDGETID} of type "${typeof BUDGETID}"`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai.request(BASEURL).get(QUERYSTRING);
                // manipulate
                let budget = response.body;
            ...
            it(`should return budget with ${ROOTELEMENTLENGTH} root element(s)`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai.request(BASEURL).get(QUERYSTRING);
                // manipulate
                let budget = response.body;
            ...
            if (ROOTELEMENTLENGTH > 0) {
                it(`should return budget with root element named ${ROOTELEMENTNAME} of type "${typeof ROOTELEMENTNAME}"`, () => __awaiter(void 0, void 0, void 0, function* () {
                    // get
                    let response = yield chai.request(BASEURL).get(QUERYSTRING);
                    // manipulate
                    let budget = response.body;
                ...
                it(`should return budget with root element that has amount = ${ROOTELEMENTAMOUNT} of type "${typeof ROOTELEMENTAMOUNT}"`, () => __awaiter(void 0, void 0, void 0, function* () {
                    // get
                    let response = yield chai.request(BASEURL).get(QUERYSTRING);
                    // manipulate
                    let budget = response.body;
                ...
                it(`should return budget with root element with endOfLife = ${ROOTELEMENTENDOFLIFE} of type "${typeof ROOTELEMENTENDOFLIFE}"`, () => __awaiter(void 0, void 0, void 0, function* () {
                    // get
                    let response = yield chai.request(BASEURL).get(QUERYSTRING);
                    // manipulate
                    let budget = response.body;
                    ...
                    expect(element.endOfLife).to.be.an(typeof ROOTELEMENTENDOFLIFE);
                }));
                ...
                it(`should return budget with root element that has ${ROOTELEMENTCHILDRENNAMES.length
                    ? "children named " +
...
describe("POST /budget/:id - constructing budgets", () => {
    describe("testbudget_a", () => {
        describe("POST A1", () => {
            ...
            let PAYLOAD = {};
            let response;
            before("make POST request", () => __awaiter(void 0, void 0, void 0, function* () {
                // await chai.request(BASEURL).post(ROUTE).send(PAYLOAD);
            }));
            beforeEach("GET budget", () => __awaiter(void 0, void 0, void 0, function* () {
                response = yield chai.request(BASEURL).get("/budget/3/2000/01");
            }));
            describe("API", () => {
                ...
                it('API returns budget with root element named "A1"', () => {
                    expect(response.body.root[0].name).to.equal("A2");
                });
