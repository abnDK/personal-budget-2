...
// functions
const testValue2 = (target, goal, paramName) => {
    switch (typeof goal) {
        case "string":
...
const testValue = (target, goal, paramName) => {
    switch (typeof goal) {
        case "string":
...
const testObject2 = (targetObject, goalObject, testname) => {
...
const testObject = (targetObject, goalObject, testname) => {
...
const testResponseHeaders = (response, goalObject, url = "") => {
    describe(url, () => {
...
describe("GET /budget", () => {
    it("Should return status 200", () => __awaiter(void 0, void 0, void 0, function* () {
        // get
        let response = yield chai.request(BASEURL).get("/budget");
        // manipulate
        // verify
        expect(response.status).to.eql(200);
    }));
    it("Should return content-type: application/json", () => __awaiter(void 0, void 0, void 0, function* () {
        // get
        let response = yield chai.request(BASEURL).get("/budget");
        // manipulate
    ...
    it("Should return budget named testbudget_a", () => __awaiter(void 0, void 0, void 0, function* () {
        // get
        let response = yield chai.request(BASEURL).get("/budget");
        // manipulate
    ...
    it("Should return budget named testbudget_b", () => __awaiter(void 0, void 0, void 0, function* () {
        // get
        let response = yield chai.request(BASEURL).get("/budget");
        // manipulate
        let budgets = response.body;
    ...
    it("Should return budget named testbudget_c", () => __awaiter(void 0, void 0, void 0, function* () {
        // get
        let response = yield chai.request(BASEURL).get("/budget");
        // manipulate
        let budgets = response.body;
...
describe("GET /budget/:id", () => {
    describe("testbudget_a", () => {
        ...
        it("Should return budget with 1 root element", () => __awaiter(void 0, void 0, void 0, function* () {
            // get
            let response = yield chai
                .request(BASEURL)
                .get("/budget/" + TESTBUDGET_A_ID);
        ...
        it("Should return budget with 1 root element name A5x", () => __awaiter(void 0, void 0, void 0, function* () {
            // get
            let response = yield chai
                .request(BASEURL)
                .get("/budget/" + TESTBUDGET_A_ID);
        ...
        it("Should return budget with 1 root element with end of life = true", () => __awaiter(void 0, void 0, void 0, function* () {
            // get
            let response = yield chai
                .request(BASEURL)
    ...
    describe("testbudget_b", () => {
        ...
        it("Should return budget with 1 root element name A3x", () => __awaiter(void 0, void 0, void 0, function* () {
            // get
            let response = yield chai
                .request(BASEURL)
                .get("/budget/" + TESTBUDGET_B_ID);
    ...
    describe("testbudget_c", () => {
        ...
        it("Should return budget with 1 root element name A3", () => __awaiter(void 0, void 0, void 0, function* () {
            // get
            let response = yield chai
                .request(BASEURL)
                .get("/budget/" + TESTBUDGET_C_ID);
        ...
        it("Should return budget with 1 root element with end of life = false", () => __awaiter(void 0, void 0, void 0, function* () {
            // get
            let response = yield chai
                .request(BASEURL)
                .get("/budget/" + TESTBUDGET_C_ID);
...
describe("GET /budget/:id/:year/:month", () => {
    ...
    describe("testbudget_a", () => {
        ...
        describe("period 0 - testing params", () => {
            ...
            it(`Should return status ${STATUSCODE}`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`Should return content-type: ${CONTENTTYPE}`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget named ${BUDGETNAME}`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget with id ${BUDGETID}`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget with only ${ROOTELEMENTLENGTH} root element(s)`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget with root element named ${ROOTELEMENTNAME}`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget with root element that has amount = ${ROOTELEMENTAMOUNT}`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget with root element with endOfLife = ${ROOTELEMENTENDOFLIFE}`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget with root element that has ${ROOTELEMENTPARENT ? "a" : "no"} parent`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget with root element that has ${ROOTELEMENTCHILDRENLENGTH} children`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`FIX THIS! should return budget with root element that has ${ROOTELEMENTCHILDRENNAMES.length
                ? "children named " + ROOTELEMENTCHILDRENNAMES.join(", ")
                : "no children"}`, () => __awaiter(void 0, void 0, void 0, function* () {
                var _a;
                // get
                let response = yield chai
                    .request(BASEURL)
                ...
                // verify
                ((_a = element === null || element === void 0 ? void 0 : element.children) === null || _a === void 0 ? void 0 : _a.length // THIS DOES NOT WORK WITH
                )
                    ? expect(element.children.map((child) => child.name)).to.have.members(ROOTELEMENTCHILDRENNAMES)
                    : expect(element).to.not.have.property("children");
                expect(true).to.be.false;
            }));
            it(`should return budget with root element that has no next or nextid element`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
            ...
            it(`should return budget with root element that has no prev or prevId element`, () => __awaiter(void 0, void 0, void 0, function* () {
                // get
                let response = yield chai
                    .request(BASEURL)
                    .get("/budget/" +
    ...
    describe("testbudget_c", () => {
        ...
        describe.only("Test return object", () => {
            testObject2({ name: "anders", horse: "not undefined" }, { name: "anders", horse: undefined });
        });
        describe("period 0 - testing params", () => {
            /**
             * TEST OF PERIOD 0:
            ...
            describe("testing headers", () => __awaiter(void 0, void 0, void 0, function* () {
                let response = yield chai.request(BASEURL).get(QUERYSTRING);
                testResponseHeaders(response, {
                    statuscode: STATUSCODE,
                    contentType: CONTENTTYPE,
                });
            }));
            describe("testing body", () => __awaiter(void 0, void 0, void 0, function* () {
                let response = yield chai.request(BASEURL).get(QUERYSTRING);
                ...
                testObject({
                    ...
                    rootElementChildrenNames: target.root[0].children.map((child) => child.name),
                    rootElementNext: target.root[0].next,
                    rootElementPrev: target.root[0].prev,
                }, EXPECTED, "test de test");
            }));
            /*
