...
/* IS THIS EVER CALLED?*/
export const getCategoriesAsTree = function () {
...
export const getTransactionsByCategoryId = function (category_id) {
    return __awaiter(this, void 0, void 0, function* () {
...
export const deleteCategoryRequest = function (category_id) {
...
export const handleCategoryTransactionForeignKeyConstraint = function (category_id) {
    return __awaiter(this, void 0, void 0, function* () {
        /**
...
export const deleteCategory = function (category_id) {
    return __awaiter(this, void 0, void 0, function* () {
        /**
...
export const getCategoryChildren = function (category_id) {
    return __awaiter(this, void 0, void 0, function* () {
...
// GET CATEGORY BY ID
export const categoryById = function (categoryId) {
...
export const updateCategoryRequest = function (category) {
    if (category.id == 17) {
...
export const updateCategoryNameAmountRequest = function (category) {
    const categoryRequestObject = {
        name: category.name,
        amount: category.amount,
        parent_id: null,
...
export const updateCategoryIdOfTransaction = function (transactionId, newCategoryId) {
